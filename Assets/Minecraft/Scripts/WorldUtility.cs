...
namespace Minecraft.Scripts
{
  ...
  {
    public static void AccessorSpaceToAccessorSpacePosition(this IWorldRAccessor self, IWorldRAccessor accessor,
      ref int x, ref int y, ref int z)
    {
      var origin = self.WorldSpaceOrigin - accessor.WorldSpaceOrigin;
      x += origin.x;
      y += origin.y;
      z += origin.z;
    }
    ...
    public static void WorldSpaceToAccessorSpacePosition(Vector3Int accessorWorldSpaceOrigin, ref int x, ref int y,
      ref int z)
    {
    ...
    public static void AccessorSpaceToWorldSpacePosition(Vector3Int accessorWorldSpaceOrigin, ref int x, ref int y,
      ref int z)
    {
      x += accessorWorldSpaceOrigin.x;
      y += accessorWorldSpaceOrigin.y;
